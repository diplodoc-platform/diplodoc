      ...
      `${JSON.stringify(
        {
          ...
          pending_version: pkg.pendingVersion,
          ci: pkg.ci,
          snapshots: pkg.snapshots,
          blocked_by: pkg.blockedBy,
          error: pkg.error,
          // Field names the report's table renderer reads back directly.
          featurePr: pkg.featurePr,
          releasePr: pkg.releasePr,
          npmVersion: pkg.npmVersion,
          pendingVersion: pkg.pendingVersion,
          mergeReadiness: pkg.mergeReadiness,
          needsHuman: pkg.needsHuman,
          blockedBy: pkg.blockedBy,
        },
        null,
        2,
      )}\n`,
